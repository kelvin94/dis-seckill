...
EnableGlobalMethodSecurity - This is used to enable method level security based on annotations. You can use following three types of annotations for securing your methods
 “securedEnabled": It enables the @Secured annotation using which you can protect your controller/service methods like so -
        ...
        @Secured("ROLE_ADMIN") // The @Secured annotation is used to specify a list of roles on a method. Hence, a user only can access that method if she has at least one of the specified roles.
 ...
 -----------------@Secured - @RolesAllowed 区别：功能上来说是一样，但是 @RolesAllowed 来自Standard annotation of Java; @Secured来自Spring Security annotation
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
   ...
   WebSecurityConfigurerAdapter implements Spring Security’s WebSecurityConfigurer interface. It provides default security configurations and allows other classes to extend it and customize the security configurations by overriding its methods.
    ...
    We’ll also define a custom UserPrincipal class that will implement UserDetails interface, and return the UserPrincipal object from loadUserByUsername() method.
     */
